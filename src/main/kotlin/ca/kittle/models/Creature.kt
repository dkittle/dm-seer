...
data class Creature (
    ...
    val actions: List<BaseAction> = arrayListOf(),
    val bonusActions: List<BaseAction> = arrayListOf(),
    val reactions: List<BaseAction> = arrayListOf(),
    val mythicActions: List<BaseAction> = arrayListOf(),
    val legendaryActions: List<BaseAction> = arrayListOf(),
