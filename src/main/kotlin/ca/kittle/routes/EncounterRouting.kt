...
//        }
            get("/ddb") {
                val encounters = ddbProxy.encounters() ?: return@get call.respondText(
                    "Could not get your encounters",
    ...
    authenticate {
        route("/api/encounter") {
            get("/ddb/{id?}") {
                ...
                val encounter = ddbProxy.encounter(id) ?: return@get call.respondText(
