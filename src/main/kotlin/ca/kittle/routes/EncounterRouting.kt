...
//        }
            get("/ddb") {
                val (accountId, _, _, vttKey) = call.sessions.get<UserSession>() ?:
                ...
                val encounters = ddbProxy.encounters(vttKey) ?: return@get
                    call.respondText("Could not get your encounters", status = HttpStatusCode.BadRequest)
    ...
    authenticate {
        route("/api/encounter") {
            get("/ddb/{id?}") {
                ...
                val encounter = ddbProxy.encounter(vttKey, id) ?: return@get call.respondText(
